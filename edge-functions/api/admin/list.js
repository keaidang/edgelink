...
function verifyAdminAuth(context) {
  // Retrieve ADMIN_TOKEN env variable
...
export default async function onRequest(context) {
  ...
  try {
    ...
    // 2. Fetch list of keys from KV
    const listResult = await kv.list({ prefix: 'link:' });
    ...
    // Filter out potential nulls and sort by createdAt descending
